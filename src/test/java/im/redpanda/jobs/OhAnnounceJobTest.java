...
class OhAnnounceJobTest {
  ...
  @Test
  void newRegistrationStagger_isShortAndStrictlyBelowFullStagger() {
  ...
  @Test
  void newRegistration_isScheduledWithinTheShortStagger() {
  ...
  @Test
  void periodicReAnnounce_keepsTheFullStagger() {
