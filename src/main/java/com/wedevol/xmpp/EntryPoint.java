...
public class EntryPoint extends CcsClient {
   ...
   */
  private static final String FCM_PROJECT_SENDER_ID =
      "987525438504"; // NOSONAR (secrets:S6710): legacy demo requires

  // inline FCM credentials
  private static final String FCM_SERVER_KEY =
      "AAAA5e0aXCg:APA91bFoUwqHX8StPUDjqXmA0L5_FCTrQhceDSJ_YxEpQZmCVZtCEDV271GYlvkqRMFizc1YspU4A41t5W8ZGHcKX1FTCpp9_yWj6oc7Q0gru0n8QunhTvH5I-pShvakwH2aGkjxbe_d"; // NOSONAR
  ...
  public EntryPoint(String projectId, String apiKey, boolean debuggable) {
    ...
    String toRegId =
        "exYJbkeSRsmgDXPlfDne4f:APA91bEqPu4sth0fQ83-HtJtI7YzYE0Dbede33DfOiSwcxQUPVo_XnUCmw-0MIcLXzuZpl7_td43UyMRQ-t-6JMI-GMFgOEXf2ZNAvZ-Ho62VwmhLu305By4vUCoKZymbBO34yXatp4_";
