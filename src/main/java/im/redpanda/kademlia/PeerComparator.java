...
/**
 * A Comparator to compare 2 Peers to a given key, modified for peers, original from Joshua Kissoon
 * github: https://github.com/JoshuaKissoon/Kademlia
 */
public class PeerComparator implements Comparator<Peer> {
  ...
  /**
   * Compare two objects which must both be of type <code>Peer</code> and determine which is closest
   * to the identifier specified in the constructor.
   *
