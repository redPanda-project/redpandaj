...
public class PeerInHandshake {
  ...
  public void activateEncryption() {
    ...
    try {
      ...
      /**
       * todo we have to use a encryption authentication algorithm for the stream but currently
       * bouncycastle AES/GCM only support block cipher! maybe we should go for the chacha20-poly,
       * but how to start a new round?
       */
