 ...
 *
 * <p>You may instead wish to work with VersionedChecksummedBytes, which adds support for testing
 * the prefix and suffix bytes commonly found in addresses.
 *
 * <p>Satoshi says: why base-58 instead of standard base-64 encoding?
 *
 * <p>
 *
 * <ul>
...
public class Base58 {
  ...
  public static byte[] decodeChecked(String input) throws AddressFormatException {
    ...
    if (tmp.length < 4) throw new AddressFormatException("Input to short");
